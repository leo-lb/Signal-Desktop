...
if [[ "$ELECTRON_BUILD_DIR" == "" ]]; then
  ...
  echo
  echo "If you want to build Electron yourself, Signal needs the version 4.2.x, you can look at https://github.com/leo-lb/electron/blob/electron-ppc64le-4.2.4/README.md for instructions."
...
NODE_ENV=production SIGNAL_ENV=production $ELECTRON_BUILD_DIR/electron .
